        ...
        <div class="col-lg-12">
            <div class="panel panel-inverse" data-sortable-id="form-validation-1">
                <div class="panel-heading">
                    <h2 class="panel-title">Seleccione Rango de Fecha Para Listado de CUENTAS POR COBRAR  de cleintes que abonaorn y no han pagado..</h2>
                </div>
                <div class="panel-body">
                    <form action="<?=base_url()?>index.php/Reporte/cxc_cliente_abonos" class="form-horizontal"
