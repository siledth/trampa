        ...
        <div class="col-lg-12">
            <div class="panel panel-inverse" data-sortable-id="form-validation-1">
                <div class="panel-heading">
                    <h1 class="panel-title">Seleccione Rango de Fecha Para Listado de productos despachados a clientes</h1>
                </div>
                <div class="panel-body">
                    <form action="<?=base_url()?>index.php/Reporte/prod_desp_client" class="form-horizontal"
                        data-parsley-validate="true" name="demo-form" method="POST">
                        <div class="row">
                        <div class="col-12">
                            <h6 class="text-center"> <b>Parametros de Búsqueda</b></h6>
                        </div>
                        <div class="form-group row col-4 mt-3 ml-5">
                            <label class="col-md-3 col-form-label">Selecciona:</label>
                            <div class="col-md-8">
                                <select class="form-control default-select2" name="producto" id="producto">
                                    <option value="1">Todos</option>
                                    <?php foreach ($producto as $data) : ?>
                                        <option value="<?= $data['code_p']?>"><?= $data['code_p'] ?> / <?= $data['descripcion'] ?>
                                        </option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
