        ...
        <div class="col-lg-12">
            <div class="panel panel-inverse" data-sortable-id="form-validation-1">
                <div class="panel-heading">
                    <h4 class="panel-title">Seleccione Rango de Fecha Para Listado de CONDICIÓN DE PAGO</h4>
                </div>
                <div class="panel-body">
                    <form action="<?=base_url()?>index.php/Reporte/condxpagar" class="form-horizontal"
