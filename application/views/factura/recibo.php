                            ...
                            <fieldset class="border border-success p-20 shadow-lg">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-4">
                                        <label>Selecciona Cliente<b title="Campo Obligatorio"
                                        ...
                                        <select style="width: 100%;" onclick="trae_inf();" id="matricular"
                                            ...
                                            <option value="<?=$data['id_cliente']?>">
                                                <?=$data['nombre_clien']?> / <?=$data['rif_clien']?></option>
                                            <?php endforeach; ?>
                                        </select>
                                    </div>

                                    <div class="col-12 text-center">
                                        <h4 style="color:red;">Datos del Cliente</h4>
                                    </div>
                                    <div class="col-3">
                                        <label>Cédula</label>
                                    ...
                                    <div class="form-group col-2">
                                        ...
                                        <input type="text" name="tele_1" id="tele_1" class="form-control" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-3">
                                        ...
                                        <input type="hidden" name="id_vendedor" id="id_vendedor" class="form-control"
                                            readonly>
                                        <input type="text" name="nombre_vendedor" id="nombre_vendedor"
                                            class="form-control" readonly>
                            ...
                            <fieldset class="border border-success p-20 shadow-lg">
                                <div class="row">
                                    ...
                                    <div class="form-group col-2">
                                        ...
                                        <input id="costo_u" name="costo_u" type="text" class="form-control" readonly>
...
<script src="<?=base_url()?>/js/bien/guardar_recibo.js"></script>
