                        ...
                        <div class="row">
                            ...
                            <div class="col-9 mt-1">
                                <div class="text-center bg-white">
                                    <h5 class="mt-1"> <b>Recibo de Compras</b></h5>
                            ...
                            <div class="form-group col-2">
                                <h6>Razón Social </h6>
                                <h6><b><?=$factura_ind['nombre_proveedor']?></b> </h6>
                            </div>
                            <div class="form-group col-2">
                                <h6>Rif </h6>
                                <h6><b><?=$factura_ind['rif_proveedor']?></b> </h6>
                            </div>
                            <div class="form-group col-2">
                                <h6>N° Factura proveedor<b title="Campo Obligatorio" style="color:red"></b> </h6>
                                <h6><b><?=$factura_ind['n_fac_proveedor']?></b> </h6>
                            </div>
