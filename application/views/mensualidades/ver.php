                            ...
                            <div class="col-md-12">
                                <div class="panel-body">
                                    <div class="col-12 text-center">
                                        <h4>Cuentas por Pagar de acuerdo al día</h4>
                                    </div>
                                    ...
                                    <table id="data-table-default" data-order='[[ 0, "desc" ]]'
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th width="25%" class="text-nowrap">N° Factura</th>
                                                <th width="10%" class="text-nowrap">Proveedor</th>
                                        ...
                                        <tbody>
                                            ...
                                            <td><?= $lista['id'] ?></td>
                                                ...
                                                <?php if ( $lista['forma_pago'] == 2) : ?>
                                                    <a class="button"
                                                        href="<?php echo base_url() ?>index.php/Mensualidades/verPago?id=<?php echo $lista['id']; ?>">
