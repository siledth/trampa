                                                ...
                                                <tr class="odd gradeX">
                                                    ...
                                                    <td>
                                                        ...
                                                        <?php if ($lista['id_status'] != 2) : ?>
                                                            <a onclick="modal(<?php echo $lista['id_mensualidad'] ?>);" data-toggle="modal" data-target="#exampleModal" style="color: white">
                                                                <i title="Pagar" class="fas fa-lg fa-fw fa-donate" style="color: darkgreen;"></i>
                                                            </a>
                                                        <?php endif; ?>
                                                    </td>
                                                </tr>
