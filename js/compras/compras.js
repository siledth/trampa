...
$('#matricular').on('select2:select', function (e) {
    ...
    var base_url =window.location.origin+'/trampa/index.php/Proveedores/listar_info';
//llenan los datos en la factura del propietario
    $.ajax({
        ...
        success: function(response){
            ...
            $("#cedula").val(response['rif_proveedor']);
   ...
   // $('#cant_total_distribuir').val(cant_total_distribuir);
    ...
    /*if (pies < 1) {
        ...
        //Remplazar decimales para caculos
            ...
            //Remplazar decimales para caculos costo_u
            var costos = $('#costo_u').val();
