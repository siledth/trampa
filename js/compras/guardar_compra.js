$(document).ready(function(){
    ...
    var base_url = window.location.origin+'/trampa/index.php/Factura/cons_nro_compra';
...
function guardar_bien(){
    ...
    swal.fire({
        ...
        if (result.value == true) {
            ...
            var base_url =window.location.origin+'/trampa/index.php/Factura/registrar_compra';
            var base_url_3 =
                    window.location.origin + "/trampa/index.php/Factura/ver_compra?id=";
